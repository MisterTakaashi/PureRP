...
SKIN.PrintName		= "PureSystem Skin"
SKIN.Author		= "MisterTakaashi && Achild0"
SKIN.DermaVersion	= 1
SKIN.GwenTexture	= Material( "pureskin.png" )
...
SKIN.tex.CategoryList.Outer		= GWEN.CreateTextureBorder( 320, 352, 63, 31, 8, 8, 8, 8 )
...
SKIN.Colours.Button = {}
SKIN.Colours.Button.Normal			= GWEN.TextureColor( 4 + 8 * 4, 508 )
SKIN.Colours.Button.Hover			= GWEN.TextureColor( 4 + 8 * 4, 508 )
...
derma.DefineSkin( "PureSkin", "Skin de PureSystem", SKIN )